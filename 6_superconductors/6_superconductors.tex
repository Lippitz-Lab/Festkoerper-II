...
Die Unterscheidung zwischen 'normalen' Elektronen und 'wechselwirkenden' Elektronen im letzten Abschnitt ist natürlich nur ein Gedankenexperiment. In Wirklichkeit wirkt die Elektron-Phonon-Wechselwirkung bei allen Elektronen. Der Abstand der beiden Elektronen in einem Cooper-Paar ist aber viel kleiner als der mittlere Abstand zwischen allen Elektronen. An dieser Stelle bricht das Bild der Cooper-Paare eigentlich zusammen und man braucht Vielteilchen-Quantenmechanik.\sidenote{siehe z.B. \cite{Czycholl_theo_FK1}} Man findet dann, dass sehr viele Elektronen einen gemeinsamen Quantenzustand besetzen. Im Cooper-Paar-Bild ist dies ähnlich zur Kondensation von Bosonen, analog zur Bose-Einstein-Kondensation von kalten Atomen oder zur stimulierten Emission von Photonen (ebenfalls Bosonen) im Laser.
