...
d = CSV.read("../data/Conwell_1952_fig1.csv", DataFrame);
...
begin
	...
	plot(t, @. n(t, 7e15) ; yaxis=((1e11,1e17),:log),legend = false, )
	scatter!(1 ./ d.x, d.Curve1)
	
	scatter!(1 ./ d.x, d.Curve2)
	plot!(t, @. n(t, 13e14) )
	
	scatter!(1 ./ d.x, d.Curve3)
	plot!(t, @. n(t, 8e13) )
...
begin
	...
	myaxis = @pgf PGFPlotsX.SemiLogYAxis(
		...
		#	ymax = 1,
	        xmin =0, xmax =420,
			ylabel = raw"Dichte $n$ (1/cm)",
			xlabel=raw"Temperatur $T$ (K) ",
	...
	push!(myaxis, raw"\draw[dashed]  (0,13e14) -- (100,13e14);")
	push!(myaxis, raw"\draw[dashed]  (0,8e13) -- (100,8e13);")
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "6b84b64321a2ca0b857739a5c016bab97ba1b242"
