...
\renewcommand{\lastmod}{9. Mai  2023}
...
\end{equation}
wobei der Wellenvektor $\mathbf{k}$ jetzt als Quantenzahl gesehen wird. Wir können ihn immer so wählen, dass er in der ersten Brillouinzone liegt.\sidenote{Den Rest kann man immer in die Summe über $\mathbf{G}$ verschieben.} Ebenso bekommt die Energie $E$ aus Gl.~\ref{eq:2_SG_rezi} ein   $\mathbf{k}$ als Index
\begin{equation}
